        ...
        , toolBarManager(0)
{
    ...
    ui->viewTurnRestrictionsAction->setChecked(M_PREFS->getViewTurnRestrictions());
...
void MainWindow::on_viewTurnRestrictionsAction_toggled(bool val)
{
    M_PREFS->setViewTurnRestrictions(val);
    invalidateView();
}

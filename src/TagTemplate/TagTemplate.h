...
public:
    ...
    bool parseCommonElements(const QDomElement& e);
...
class TagTemplateWidgetMemberList: public TagTemplateWidget
{
    Q_OBJECT
...
public:
    ...
    static TagTemplateWidgetMemberList*		fromXml(const QDomElement& e);
    bool toXML(QDomElement& xParent, bool header);

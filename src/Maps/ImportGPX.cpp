...
static void importGPX(const QDomElement& Root, MapDocument* theDocument, QList<TrackMapLayer*>& theTracklayers, CommandList* theList, bool MakeSegment, QProgressDialog & progress)
{
	for(QDomNode n = Root.firstChild(); !n.isNull(); n = n.nextSibling())
	{
		QDomElement t = n.toElement();
...
bool importGPX(QWidget* aParent, QIODevice& File, MapDocument* theDocument, QList<TrackMapLayer*>& theTracklayers, bool MakeSegment)
{

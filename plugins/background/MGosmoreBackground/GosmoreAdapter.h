...
#ifndef GOSMOREADAPTER_H
#define GOSMOREADAPTER_H
...
class GosmoreAdapter : public IMapAdapter
{
    Q_OBJECT
...
class GosmoreAdapterFactory : public QObject, public IMapAdapterFactory
{
    Q_OBJECT
...
public:
     ...
     */
    IMapAdapter* CreateInstance() {return new GosmoreAdapter(); }

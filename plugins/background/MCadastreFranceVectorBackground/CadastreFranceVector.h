 ...
 ***************************************************************************/
#ifndef CADASTREFRANCEVECTORADAPTER_H
#define CADASTREFRANCEVECTORADAPTER_H
...
class CadastreFranceVectorAdapter : public IMapAdapter
{
    Q_OBJECT
    Q_INTERFACES(IMapAdapter)

public:
    CadastreFranceVectorAdapter();
    virtual ~CadastreFranceVectorAdapter();
...
class CadastreFranceVectorAdapterFactory : public QObject, public IMapAdapterFactory
{
    Q_OBJECT
...
public:
     ...
     */
    IMapAdapter* CreateInstance() {return new CadastreFranceVectorAdapter(); }

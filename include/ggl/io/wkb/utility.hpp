...
{
    // TODO: Fix pre-condition assert
    //BOOST_STATIC_ASSERT((boost::is_convertible<std::iterator_traits<OutputIterator>::iterator_category, std::output_iterator_tag>::value;));
